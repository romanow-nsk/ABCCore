...
public class DAO implements I_ExcelRW, I_MongoRW {
    ...
    //public final static byte ValuesBase.DAOInt=0,ValuesBase.DAOString=1,ValuesBase.DAODouble=2,ValuesBase.DAOBoolean=3,ValuesBase.DAOShort=4,ValuesBase.DAOLong=5,ValuesBase.DAOString2=6,ValuesBase.DAOEntityLink=7,ValuesBase.DAOEntityLinkList=8,ValuesBase.DAOEntityRefList=9,ValuesBase.DAOLink=10,dbVoid=11;  //  ID-ы сериализуемых типов
    ...
    public String updateField(EntityField ff, String value){
        ...
        switch(ff.type){
            ...
            case ValuesBase.DAOEntityLink:
                ...
                break;
            case ValuesBase.DAOEntityLinkList:
    ...
    final public void getDBValues(String prefix, org.bson.Document out, int level, I_MongoDB mongo,
        ...
        try {
            ...
            for(int i=0;i<fld.size();i++){          // После ВСЕХ
                ...
                /*
                switch(ff.type) {
                    case ValuesBase.DAOEntityRefList:           // Загрузка по
    ...
    public void putFieldValue(String prefix, org.bson.Document out, int level, I_MongoDB mongo,EntityField ff) throws UniException{
        try {
            ...
            /*
            switch(ff.type){
            case ValuesBase.DAOInt:	    out.put(prefix+ff.name,ff.field.getInt(this)); break;
            case ValuesBase.DAOShort:	out.put(prefix+ff.name,ff.field.getShort(this)); break;
            case ValuesBase.DAOLong:	out.put(prefix+ff.name,ff.field.getLong(this)); break;
            case ValuesBase.DAODouble:	out.put(prefix+ff.name,ff.field.getDouble(this)); break;
            case ValuesBase.DAOBoolean: out.put(prefix+ff.name,ff.field.getBoolean(this));break;
            case ValuesBase.DAOString2:
            case ValuesBase.DAOString:	out.put(prefix+ff.name,ff.field.get(this)); break;
            ...
            case ValuesBase.DAOLink:
                ...
                if (pref!=null)
                    ...
                    noField(2,ff);
                break;
            case ValuesBase.DAOEntityRefList:         // НЕ ПИШЕТСЯ
                 break;
                }
             */
            }
                ...
                switch(ff.type){
                    ...
                    case ValuesBase.DAOLink:
                        ...
                        if (pref!=null)
                            ...
                            noField(3,ff);
                        break;
                    case ValuesBase.DAOEntityRefList:
        ...
        try {
           getFields();
            ...
            for(int i=0;i<fld.size();i++){
                ...
                /*
                switch(ff.type){
                    case ValuesBase.DAOInt:	    row.createCell(cnt.getIdx()).setCellValue(ff.field.getInt(this)); break;
                    case ValuesBase.DAOShort:	row.createCell(cnt.getIdx()).setCellValue(ff.field.getShort(this)); break;
                    case ValuesBase.DAOLong:	row.createCell(cnt.getIdx()).setCellValue(ff.field.getLong(this)); break;
                    case ValuesBase.DAODouble:	row.createCell(cnt.getIdx()).setCellValue(ff.field.getDouble(this)); break;
                    case ValuesBase.DAOBoolean: row.createCell(cnt.getIdx()).setCellValue(ff.field.getBoolean(this) ? 1:0);break;
                    case ValuesBase.DAOString2:
                    case ValuesBase.DAOString:	row.createCell(cnt.getIdx()).setCellValue((String) ff.field.get(this));
                        break;
                    case ValuesBase.DAOEntityLink:
                        EntityLink link = (EntityLink)ff.field.get(this);
            ...
            for(int i=0;i<fld.size();i++){
                ...
                switch(ff.type){
                    ...
                    case ValuesBase.DAOString:
                        ...
                        break;
                    case ValuesBase.DAOEntityLink:            // САМИ ОБЪЕКТЫ НЕ КОПИРУЮТСЯ И ССЫЛКИ ТОЖЕ
                        EntityLink link = (EntityLink)ff.field.get(this);
